...
function MobileMenu() {
  ...
  return (
    <section className="bg-white border-b b-gray-300 flex justify-between items-center gap-9 relative xl:hidden z-50 transition-all w-full">
      <div
        className={`${menuActive ? "w-full" : "w-0"
      ...
      <div
        className={`text-gray-900 h-full lg:text-2xl py-6 rounded-br-md text-xl z-40 font-medium leading-9 flex gap-4 pl-[5%] pr-[5%] fixed top-[93px] ${menuActive ? " left-0" : "-left-[100%]"
