...
function MonthFilter({ options }) {
  ...
  return (
    <div className="date-filter relative">
      ...
      <div
        id="month-filter"
        className={`absolute right-0 top-5 z-10 overflow-hidden rounded-lg bg-white shadow-lg dark:bg-darkblack-500 ${showFilter ? "block" : "hidden"
          }`}
      >
        <ul>
