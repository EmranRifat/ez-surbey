      ...
      <div className="relative">
        ...
        >
          <span className="text-sm font-bold text-bgray-900 dark:text-white">
            {Filter ? Filter : currencyOptions[0]}
          </span>
          <span>
            <svg
              width="17"
        ...
        <div
          id="usd-filter"
          className={`rounded-lg w-full shadow-lg bg-white dark:bg-darkblack-500 absolute right-0 z-10 top-14 overflow-hidden ${showFilter ? "block" : "hidden"
            }`}
        >
          <ul>
