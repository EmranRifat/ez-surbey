...
function Filter({ options }) {
  ...
  // console.log("filterOther-->", options);
  ...
  return (
    <div className="relative h-12 flex-1">
      <button
        ...
        type="button"
        className="flex h-full w-40 items-center justify-center rounded-lg border border-bgray-300 bg-bgray-100 dark:border-darkblack-500 dark:bg-darkblack-500"
      >
