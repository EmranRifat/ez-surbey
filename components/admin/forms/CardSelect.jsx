    ...
    <div className="payment-select relative mb-3">
      ...
      >
        <div className="flex space-x-2 items-center">
          <span>{Filter ? currencyOptions[Filter] : currencyOptions[0]}</span>
        </div>
        <div className="flex space-x-2 items-center">
      ...
      <div
        id="paymentFilter"
        className={`rounded-lg shadow-lg w-full bg-white absolute right-0 z-10 top-full overflow-hidden ${showFilter ? "block" : "hidden"
          }`}
      >
        <ul>
