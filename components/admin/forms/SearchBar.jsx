function SearchBar() {
  return (
    <div className="searchbar-wrapper">
      <div className="px flex h-[46px] w-[300px] items-center justify-between rounded-lg border border-transparent bg-bgray-50 px-4 focus-within:border-success-300 dark:bg-darkblack-500 lg:w-[400px]">
