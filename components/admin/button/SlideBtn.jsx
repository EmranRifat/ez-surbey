  ...
  return (
    <div className="flex items-center justify-between">
      ...
      >
        <span
          aria-hidden="true"
          className={`pointer-events-none inline-block h-4 w-4 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${status[name] ? "translate-x-5" : ""
            }`}
        ></span>
      </button>
    </div>
