  ...
  return (
    <div className="flex sm:flex-row flex-col sm:items-center items-end justify-between pb-5 border-b border-bgray-300 dark:border-darkblack-400">
      ...
      <button
        ...
        className={`switch-btn text-center relative inline-flex h-5 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${isActive ? "bg-success-300 active" : "bg-[#9AA2B1]"
          }`}
      ...
      >
        ...
        <span
          aria-hidden="true"
          className={`pointer-events-none inline-block h-4 w-4 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${isActive ? "translate-x-5 active" : "translate-x-0"
            }`}
        ></span>
      </button>
    </div>
